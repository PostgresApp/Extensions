...
echo
mkdir -p Build
curl -L https://github.com/timescale/$REPO_NAME/archive/refs/tags/$EXTENSION_VERSION.tar.gz | tar x --cd Build
...
echo
(
	cd Build/$REPO_NAME-$EXTENSION_VERSION/extension
...
cat Build/$REPO_NAME-$EXTENSION_VERSION/LICENSE >Build/Resources/license.txt
